package com.ostep.smartrefresh.layout;
...
import com.ostep.smartrefresh.layout.api.DefaultRefreshFooterCreator;
import com.ostep.smartrefresh.layout.api.DefaultRefreshHeaderCreator;
import com.ostep.smartrefresh.layout.api.DefaultRefreshInitializer;
import com.ostep.smartrefresh.layout.api.RefreshContent;
import com.ostep.smartrefresh.layout.api.RefreshFooter;
import com.ostep.smartrefresh.layout.api.RefreshHeader;
import com.ostep.smartrefresh.layout.api.RefreshInternal;
import com.ostep.smartrefresh.layout.api.RefreshLayout;
import com.ostep.smartrefresh.layout.constant.DimensionStatus;
import com.ostep.smartrefresh.layout.constant.RefreshState;
import com.ostep.smartrefresh.layout.constant.SpinnerStyle;
import com.ostep.smartrefresh.layout.footer.BallPulseFooter;
import com.ostep.smartrefresh.layout.header.BezierRadarHeader;
import com.ostep.smartrefresh.layout.impl.RefreshContentWrapper;
import com.ostep.smartrefresh.layout.impl.RefreshFooterWrapper;
import com.ostep.smartrefresh.layout.impl.RefreshHeaderWrapper;
import com.ostep.smartrefresh.layout.impl.ScrollBoundaryDeciderAdapter;
import com.ostep.smartrefresh.layout.listener.OnLoadMoreListener;
import com.ostep.smartrefresh.layout.listener.OnMultiPurposeListener;
import com.ostep.smartrefresh.layout.listener.OnRefreshListener;
import com.ostep.smartrefresh.layout.listener.OnRefreshLoadMoreListener;
import com.ostep.smartrefresh.layout.listener.OnStateChangedListener;
import com.ostep.smartrefresh.layout.listener.SimpleMultiPurposeListener;
import com.ostep.smartrefresh.layout.util.SmartUtil;
import com.scwang.smartrefresh.layout.R;
import com.ostep.smartrefresh.layout.api.RefreshKernel;
import com.ostep.smartrefresh.layout.api.ScrollBoundaryDecider;
...
//                  mRefreshFooter.getView().requestLayout();
    ...
    public RefreshLayout setHeaderInsetStart(float insetDp) {
        mHeaderInsetStart = SmartUtil.dp2px(insetDp);
        return this;
    }
    ...
    public RefreshLayout setFooterInsetStart(float insetDp) {
        mFooterInsetStart = SmartUtil.dp2px(insetDp);
        return this;
    }
